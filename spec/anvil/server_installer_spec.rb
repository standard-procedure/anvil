...
RSpec.describe Anvil::ServerInstaller do
  subject { Anvil::ServerInstaller.new(host, configuration, private_key, passphrase, {logger: logger, ssh_executor: ssh_executor}) }
  ...
  let(:ssh_executor) { double "Anvil::SshExecutor", exec!: true }
